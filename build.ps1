...
plc ./source/clampandsaw.st ./source/builtins_test.st --xml-omron -i ./source/externals.st -i ./source/omron.st -l iec61131std -l ws2_32 -l ntdll -l userenv -o ./compiled/lib_structured_text.xml
